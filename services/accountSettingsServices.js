...
exports.view_rate_us = async function(form_data, req, res, next) 
{
    try{                  
    var user_id = htmlspecialchars(form_data.id);
    
    var rate_us_data = await accountSettingsModel.view_rate_us(user_id);   
    var rate_us_data_array = [];
    if (rate_us_data.length != 0)
    { 
        for (const rate_us of rate_us_data) 
        {    // set any value to Map
            rate_us_data_array.push({
                rate_us_option_1                      :rate_us.rate_us_option_1,
                rate_us_option_2                :rate_us.rate_us_option_2,
                rate_us_option_3            :rate_us.rate_us_option_3,
                rate_us_option_4                 :rate_us.rate_us_option_4,
                rate_us_option_5                  :rate_us.rate_us_option_5,
                rate_us_option_6          :rate_us.rate_us_option_6,
                specify_issue                   :rate_us.specify_issue,
                specify_issue2                :rate_us.specify_issue2,
...
exports.view_account_settings = async function(form_data, req, res, next) 
{
    ...
    for (const WarehouseAddress of get_account_details) 
    {
        get_account_array.push({
            ...
            fssai_number                    : WarehouseAddress.fssai_number,
 ...
 try{
    ...
    {    // set any value to Map
        view_contract_acceptance_array.push({
            ...
            contract_file_name      :'https://new-itl-uploads.s3.ap-south-1.amazonaws.com/uploads/nodejs_uploads/company_logo/temp_file/'+view_contract_acceptance.contract_file_name,
    ...
    { 
        ...
        {    // set any value to Map
            ...
            user_contract_history_array.push({
                ...
                //https://new-itl-uploads.s3.ap-south-1.amazonaws.com/uploads/nodejs_uploads/company_logo/temp_file/b7ae924f0ca13efeed6ae72af117e1b0.pdf
                ...
                user_contract_file_name :'https://new-itl-uploads.s3.ap-south-1.amazonaws.com/uploads/nodejs_uploads/company_logo/temp_file/'+user_contract_history.user_contract_file_name,
...
exports.update_account_details = async function(form_data, req, res, next) 
{
    ...
    var fssai_number            = htmlspecialchars(form_data.fssai_number);
    ...
    if(vendor_email == "")
    {
        ...
        { 
            ...
            var update_user_fssai_query = "UPDATE user_extra SET fssai_number = ? WHERE id = ?";
            var update_user_fssai_query_key = [fssai_number,user_id]
            var update_user_billing_address__fssai_details_query = await accountSettingsModel.update_user_address(update_user_fssai_query,update_user_fssai_query_key);
...
exports.update_kyc_details = async function(form_data, req, res, next) 
{
    ...
    var uploadimage="";
        ...
        if(type == "0" || type == 0 || type == "2" || type == 2)
        {
